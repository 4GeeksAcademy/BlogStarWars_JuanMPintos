...
export const VistaPersonaje = () => {
    ...
    useEffect(() => {
        actions.cargarPersonaje(parametros.uid).then(data => setInfo(data))
    }, [])
    if (info)

        return (
            <div className="personaje card mb-3">
                <img src={`https://starwars-visualguide.com/assets/img/characters/${parametros.uid}.jpg`}  className="foto_detalle card-img-top" alt="..." />
